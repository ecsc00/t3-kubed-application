...
The t3-kubed-infrastructure contains the terraform files for spinning up the AWS infrastructure 
...
The same url need to be passed as the environment variable to run the automation testing pipeline.
